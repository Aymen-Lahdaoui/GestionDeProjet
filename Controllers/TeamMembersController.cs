...
public class TeamMembersController : ControllerBase
{
    ...
    public async System.Threading.Tasks.Task<ActionResult<TeamMember>> PostTeamMember(TeamMember teamMember)
    {
        ...
        // Activity Logging
        await LogActivity("Ajout de Membre", $"Le membre '{teamMember.Name}' ({teamMember.Email}) a été ajouté.", "TeamMember", teamMember.Id.ToString());
    ...
    public async System.Threading.Tasks.Task<IActionResult> PutTeamMember(int id, TeamMember teamMember)
    {
        ...
        try
        {
            await _context.SaveChangesAsync();
            // Activity Logging
            await LogActivity("Mise à jour de Membre", $"Le membre '{teamMember.Name}' a été mis à jour.", "TeamMember", teamMember.Id.ToString());
    ...
    public async System.Threading.Tasks.Task<IActionResult> DeleteTeamMember(int id)
    {
        try
        {
            ...
            // Activity Logging
            await LogActivity("Suppression de Membre", $"Le membre '{teamMember.Name}' a été supprimé.", "TeamMember", id.ToString());
